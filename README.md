...
Version 5 of the FOSElasticaBundle is compatible with Elasticsearch 5 and 6. It requires Symfony 3.4, 4.x or 5.4. When using
...
| --------------------------------------------------------------------------------------- | ---------| ------------- | ------------- | ----------- |
| [5.1] (master)                                                                          | ^5.3\|^6 | 5.\*\|6.\*    | ^3.4\|^4\|^5.4| >=7.2.5     |
